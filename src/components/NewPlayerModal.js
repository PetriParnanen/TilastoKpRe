					...
					<div className="modal-body">
						...
						<div className="row">
							...
							<div className="col-md-6">
								...
								<input className="form-control" name="number" value={this.state.shirtNumber} type="text" pattern="[0-9]{1,2}" onChange={(e) => this.fieldHandler(e)} required />
							</div>
						</div>
						<div className="row">
							<div className="col-md-12">
								<label>{ t('PLAYER.JOIN') }</label>
								<input className="form-control" name="joining_date" value={this.state.joiningDate} type="date" onChange={(e) => this.fieldHandler(e)} />
							</div>
						</div>
